<?php
   ...
   $full=$obj->display_search_post($keyword);
...
<section class="blog-posts">
      <div class="container">
        <h3>Search result for : <span><?php echo $keyword; ?></span></h3>
        <div class="row">
        ...
        <div class="col-lg-8">
            <div class="all-blog-posts">
              ...
              <?php while($postdata=mysqli_fetch_assoc($full)) {?>

                <div class="col-lg-12">
                  <div class="blog-post">
                    <div class="blog-thumb">
                    <img height="500px" src="upload/<?php echo $postdata['post_img']; ?>" alt="">
                    </div>
