            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Beautiful Life</h1>
	                        <p class="hero-paragraph">Want to know more about the world, travel with us</p>
	                        <div class="hero-cta">
								<a class="button button-primary" href="index.php">Let's Go</a>
                            ...
                            <div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	...
                                    	<p class="text-sm mb-0">Find the longest sea beach</p>
									</div>
								</div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	<h3 class="feature-title mt-0">Discover</h3>
                                    	<p class="text-sm mb-0">Find the most beautiful place</p>
									</div>
								</div>
                            </div>
							<div class="feature is-revealing">
                                <div class="feature-inner">
									...
									<div class="feature-content">
                                    	<h3 class="feature-title mt-0">Discover</h3>
                                    	<p class="text-sm mb-0">Find the place with comfortable</p>
									</div>
								</div>
                            </div>
                        </div>
